...
object Updater {
    ...
    suspend fun getLatestVersionName(): Result<String> =
        runCatching {
            val response =
                client.get("https://api.github.com/repos/sang765/ArchiveTune-Nightly/releases/latest")
                    .bodyAsText()
    ...
    fun getLatestDownloadUrl(): String {
        val baseUrl = "https://github.com/sang765/ArchiveTune-Nightly/releases/latest/download/"
        val architecture = BuildConfig.ARCHITECTURE
        return if (architecture == "universal") {
            baseUrl + "ArchiveTune_Nightly.apk"
        } else {
            baseUrl + "app-${architecture}-nightly.apk"
        }
    }
}
